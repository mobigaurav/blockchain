...
CHAINCODE_NAME="Propertycontract"
CHAINCODE_VERSION="3"
CHAINCODE_PATH="../chaincode/Propertycontract/build/install/Propertycontract"
CHAINCODE_LANG="java"
CHAINCODE_LABEL="Propertycontract_3"
...
chaincodeAddNewProperty() {
    echo "===================== Started Add new Property Chaincode Function===================== "
    setEnvVarsForPeer0Org1
    peer chaincode invoke -o $ORDERER_ADDRESS\
    --ordererTLSHostnameOverride orderer.example.com --tls $CORE_PEER_TLS_ENABLED\
    --cafile $ORDERER_CA -C ${CHANNEL_NAME} --name ${CHAINCODE_NAME}\
    --peerAddresses localhost:7051 --tlsRootCertFiles $CORE_PEER_TLS_ROOTCERT_FILE_ORG1\
    --peerAddresses localhost:9051 --tlsRootCertFiles $CORE_PEER_TLS_ROOTCERT_FILE_ORG2\
    -c '{"Args":["addNewProperty", "2", "Spacious 2BD Townhome","Harish","$400000"]}'
    echo "===================== Successfully Added new Property===================== "
}

chaincodeQueryPropertyById() {
    echo "===================== Started view Property details Chaincode Function===================== "
    setEnvVarsForPeer0Org1
    peer chaincode invoke -o $ORDERER_ADDRESS\
    --ordererTLSHostnameOverride orderer.example.com --tls $CORE_PEER_TLS_ENABLED\
    --cafile $ORDERER_CA -C ${CHANNEL_NAME} --name ${CHAINCODE_NAME}\
    --peerAddresses localhost:7051 --tlsRootCertFiles $CORE_PEER_TLS_ROOTCERT_FILE_ORG1\
    --peerAddresses localhost:9051 --tlsRootCertFiles $CORE_PEER_TLS_ROOTCERT_FILE_ORG2\
    -c '{"Args":["queryPropertyById", "2"]}'
    echo "===================== Successfully Invoked view Property Details Chaincode Function===================== "
}

chaincodeTransferPropertyOwnership() {
    echo "===================== Started Change Property Ownership Function===================== "
    setEnvVarsForPeer0Org1
    peer chaincode invoke -o $ORDERER_ADDRESS\
    --ordererTLSHostnameOverride orderer.example.com --tls $CORE_PEER_TLS_ENABLED\
    --cafile $ORDERER_CA -C ${CHANNEL_NAME} --name ${CHAINCODE_NAME}\
    --peerAddresses localhost:7051 --tlsRootCertFiles $CORE_PEER_TLS_ROOTCERT_FILE_ORG1\
    --peerAddresses localhost:9051 --tlsRootCertFiles $CORE_PEER_TLS_ROOTCERT_FILE_ORG2\
    -c '{"Args":["changePropertyOwnership", "2","Priya"]}'
    echo "===================== Successfully Invoked Change Property Ownership Chaincode Function===================== "
}

...
public class Propertycontract implements ContractInterface {
	...
	/**
	 * Retrieves a Property based upon Car Id from the ledger.
	 *
	 * @param ctx the transaction context
	 * @param id  the key
	 ...
	 */
	@Transaction()
	public Propertymodel changeCarOwnership(final Context ctx, final String id, final String newPropertyOwner) {
		ChaincodeStub stub = ctx.getStub();
